...
/**
 * An activity representing a list of SDNEvents. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link SDNEventDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p/>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link SDNEventListFragment} and the item details
 * (if present) is a {@link SDNEventDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link SDNEventListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class SDNEventListActivity extends FragmentActivity
        implements SDNEventListFragment.Callbacks {
    ...
    /**
     * Callback method from {@link SDNEventListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.sdnevent_detail_container, fragment)
                    .commit();
